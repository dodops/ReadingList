...
user1 = User.create!(email: "fulano@hotmail.com", password: "poderpoder", password_confirmation: "poderpoder")
Book.create!([{
  title: "Hyperion",
  author: "Dan Simmons",
...
booka = Book.create!(title: "UmTESTE", author: "sdsd", description: "sdsdsd")
User.create!(email: "pestos@hotmail.com", password: "poderpoder", password_confirmation: "poderpoder", books: [booka])
